	...
	<div class="container mt-3">
		...
		<form:form method="POST" action="/shows/create" modelAttribute="newShow">
			...
			<div class="form-group row pt-2">			
				<form:label path="showtitle" class="col-sm-2 col-form-label-sm">Titulo del show: </form:label>				
				<div class="col-sm-10">
			...
			<div class="text-center pt-4">
				<input type="submit" value="Agregar nuevo show" class="btn btn-lg btn-primary" />
			</div>
